...
def ingestion_settings(tmp_path: Path) -> Settings:
    ...
    beneficiary = (
        ...
        "BENE001|01|001|35004|19400101|1|1|0||2023|83|12|12|0|0\n"
    )
    ...
    inpatient = (
        ...
        "ICD9_DGNS_CD_1|CLM_FREQ_CD\n"
        "BENE001|CLM001|20230101|20230105|1200.50|01|4280|1\n"
    )
    ...
    prescription = (
        ...
        "PDE001|BENE001|20230110|20230111|00071015523|30|30|1|C\n"
    )
