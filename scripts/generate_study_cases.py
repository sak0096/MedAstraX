...
def main() -> None:
    ...
    tasks = [
        ...
        },
        {
            ...
            "time_limit_min": 5,
            "instructions": "Use the query box: 'Top 25 hospitalization risk with diabetes in analytic year 2022 with at least 50 claims.' Review the interpretation, confirm, and verify one result via drill-down.",
            "response_type": "query_flow",
            "requires_cases": [],
            "conditions": ["llm"],
            "manipulation_slot": "study2",
            "suggested_query": "Top 25 hospitalization risk with diabetes in analytic year 2022 with at least 50 claims",
        },
        {
            "task_id": "S2-T3",
            "study": "study2",
        ...
        },
        {
            ...
            "time_limit_min": 5,
            "instructions": "Run: 'Top 10 elevated cost risk with heart failure in analytic year 2022 with at least 30 claims.' Cancel and rephrase if the interpretation looks wrong before confirming.",
            "response_type": "query_flow",
            "requires_cases": [],
            "conditions": ["llm"],
            "manipulation_slot": "study2",
            "suggested_query": "Top 10 elevated cost risk with heart failure in analytic year 2022 with at least 30 claims",
        },
        {
            "task_id": "S2-T7",
            "study": "study2",
    ...
    payload = {
        ...
        "manipulation_catalog": {
            ...
            "M6": "Incorrect NL query analytic year on interpretation card",
